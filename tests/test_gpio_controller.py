...
class TestGPIOController(unittest.TestCase):
    ...
    def test_trigger_delay_charge(self, mock_sleep, mock_output) -> None:
        gpio_controller.trigger_delay_charge()
        mock_output.assert_has_calls([
            call(gpio_controller.DELAY_CHARGE_PIN, True),
    ...
    @patch('src.gpio_controller.GPIO.output')
    @patch('src.gpio_controller.time.sleep')
    def test_release_parachute(self, mock_sleep, mock_output) -> None:
        gpio_controller.release_parachute()
        mock_output.assert_has_calls([
            call(gpio_controller.PARACHUTE_PIN, True),
