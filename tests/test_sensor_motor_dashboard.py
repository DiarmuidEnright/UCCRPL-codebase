...
class TestSensorMotorDashboard(unittest.TestCase):
    ...
    def test_update_sensor_data(self, mock_get_sensor_readings):
    ...
    def test_update_motor_stats(self, mock_motor):
    ...
    def test_trigger_delay_charge_authorized(self, mock_trigger_delay_charge, mock_authenticate):
    ...
    def test_release_parachute_authorized(self, mock_release_parachute, mock_authenticate):
        mock_authenticate.return_value = True
        dashboard = SensorMotorDashboard()
        dashboard.is_authorized = False
